	...
	useDebouncedEffect(
		() => {
			const valuesChanged =
				...
				JSON.stringify(childrenValues) !==
					JSON.stringify(previousValuesRef.current?.children) ||
				JSON.stringify(configValues) !==
					JSON.stringify(previousValuesRef.current?.config) ||
				JSON.stringify(ipValues) !==
					JSON.stringify(previousValuesRef.current?.ip);
