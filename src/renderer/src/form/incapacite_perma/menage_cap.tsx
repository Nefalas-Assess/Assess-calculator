...
const CapAmount = ({
	...
	const reference = usePersoReference
		? values?.perso_reference
		: values?.reference;
							...
							<td>
								...
								>
									{childrenOnPeriod
										...
										?.toFixed(2)}
									<Tooltip
										tooltipContent={renderToolTipChildren(childrenOnPeriod)}
									>
